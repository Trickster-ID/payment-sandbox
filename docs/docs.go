...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/payment-sandbox_app_modules_ledger_models_entity.Account"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/merchants": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Prefix search on name or email (case-insensitive)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/payment-sandbox_app_modules_merchants_models_entity.MerchantSummary"
                                            }
                                        },
                                        "meta": {
        ...
        "/admin/wallet/transactions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Merchant UUID (admin only)",
                        "name": "merchant_id",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Filter direction: D (debit) or C (credit)",
                        "name": "direction",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by transaction reference prefix (e.g. topup:, refund:, payment:)",
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/app_modules_wallet_handlers.TransactionResponse"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/payment-sandbox_app_shared_response.PaginationMeta"
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.ClientResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.RegisterClientRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.RegisterClientResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.IntrospectResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.TokenResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_modules_users_handlers.RegisterRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/app_modules_users_handlers.UserResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "app_modules_users_handlers.RegisterRequest": {
            "type": "object",
            "required": [
                "email",
                "name",
        ...
        "app_modules_users_handlers.UserResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "app_modules_wallet_handlers.TransactionResponse": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "integer"
        ...
        "payment-sandbox_app_modules_ledger_models_entity.Account": {
            "type": "object",
            "properties": {
                "balance": {
                    "type": "integer"
                ...
                "type": {
                    "$ref": "#/definitions/payment-sandbox_app_modules_ledger_models_entity.AccountType"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "payment-sandbox_app_modules_ledger_models_entity.AccountType": {
            "type": "string",
            "enum": [
                "asset",
                "liability",
        ...
        "payment-sandbox_app_modules_merchants_models_entity.MerchantSummary": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "payment-sandbox_app_modules_oauth2_models_dto.ClientResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "payment-sandbox_app_modules_oauth2_models_dto.IntrospectResponse": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "payment-sandbox_app_modules_oauth2_models_dto.RegisterClientRequest": {
            "type": "object",
            "required": [
                "name",
                "redirect_uris",
        ...
        "payment-sandbox_app_modules_oauth2_models_dto.RegisterClientResponse": {
            "type": "object",
            "properties": {
                "client": {
                    "$ref": "#/definitions/payment-sandbox_app_modules_oauth2_models_dto.ClientResponse"
        ...
        "payment-sandbox_app_modules_oauth2_models_dto.TokenResponse": {
            "type": "object",
            "properties": {
                "access_token": {
                    "type": "string"
